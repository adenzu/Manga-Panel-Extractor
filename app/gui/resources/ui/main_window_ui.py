# Form implementation generated from reading ui file '../app/gui/resources/ui\main_window.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.split_joint_panels_check_box.setToolTip(_translate("MainWindow", "<html><head/><body><p>Split any panels that are joint together.</p></body></html>"))
        self.split_joint_panels_check_box.setText(_translate("MainWindow", "Split Joint Panels"))
        self.use_fallback_check_box.setToolTip(_translate("MainWindow", "<html><head/><body><p>Use another method whenever the base method fails to extract panels.</p></body></html>"))
        ...
        self.output_mode_label.setToolTip(_translate("MainWindow", "<html><head/><body><p>Bounding - Crop the original image with size and position of the bounding box of panels.</p><p>Masked - Preserve only the target panel\'s pixels in the cropped image.</p></body></html>"))
        self.output_mode_label.setText(_translate("MainWindow", "Output Mode"))
        self.output_mode_combo_box.setToolTip(_translate("MainWindow", "<html><head/><body><p>Bounding - Crop the original image with size and position of the bounding box of panels.</p><p>Masked - Preserve only the target panel\'s pixels in the cropped image.</p></body></html>"))
