...
from image_processing.panel import generate_panel_blocks, OutputMode
    ...
    def run(self):
        ...
        for i, image in enumerate(load_images(self.input_dir)):
            ...
            if self.output_to_folders:
                ...
                for k, panel in enumerate(generate_panel_blocks(image.image, split_joint_panels=self.split_joint_panels, fallback=self.fallback, mode=self.output_mode)):
